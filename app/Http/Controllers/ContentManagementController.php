...
class ContentManagementController extends Controller
{
    ...
    public function users()
    {
        ...
        return view('content-management.users.index', compact('users', 'roles'));
    }
    ...
    {
        $pageHeroes = PageHero::orderBy('page_name')->get();
        
        // Define default pages if they don't exist
        $defaultPages = [
        ...
        foreach ($defaultPages as $page) {
            if (!PageHero::where('page_slug', $page['slug'])->exists()) {
                PageHero::create([
                    'page_slug' => $page['slug'],
                    'page_name' => $page['name'],
                    'is_active' => true,
        ...
        return view('content-management.page-heroes.index', compact('pageHeroes'));
    }
    ...
    public function updatePageHero(Request $request, $id)
    {
        try {
            $request->validate([
                'background_image' => 'nullable|image|mimes:jpeg,jpg,png,gif,webp|max:2048',
            ...
            if ($request->hasFile('background_image')) {
                ...
                if ($pageHero->background_image) {
                    $oldPath = storage_path('app/public/' . $pageHero->background_image);
                ...
                $directory = storage_path('app/public/page-heroes');
