...
<div class="content">
    ...
    <div class="container-fluid pt-4 px-4">
        ...
        <div class="tab-content">
                        ...
                        <form action="{{ route('content-management.about.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <fieldset class="mb-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" name="storyDescription" rows="6" id="storyDescription">{{ optional($about)->storyDescription ?? '' }}</textarea>
                                </div>
                            </fieldset>
                            <fieldset class="mb-4">
            ...
            {{-- Tab 3: Terms & Conditions — one card, one form (only terms textarea) --}}
            <div id="terms" class="tab-pane fade">
                <div class="card shadow-sm border-0">
                    <div class="card-header bg-white py-3">
                        <h5 class="mb-1">Terms & Conditions</h5>
                        <p class="text-muted small mb-0">Content shown on the public Terms page.</p>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('content-management.terms.update') }}" method="POST">
                            @csrf
                            <label class="form-label">Content</label>
                            <textarea class="form-control" name="content" rows="15" id="termsContent">{{ optional($terms)->content ?? '' }}</textarea>
                            <div class="pt-3">
            ...
            {{-- Tab 4: SEO Keywords — one card, one form (only keywords textarea) --}}
...
$(document).ready(function() {
    $('#founderDescription, #storyDescription').summernote({ height: 300 });
    $('#termsContent').summernote({ height: 300 });
});
</script>
@endsection
