...
<div class="content">
    ...
    <div class="container-fluid pt-4 px-4">
        ...
        <div class="alert alert-info alert-dismissible fade show" role="alert">
            <strong><i class="fa fa-crown me-2"></i>Super Admin Mode:</strong> You have full access to all dashboards. Use the "Switch Dashboard" button in the top navigation to return to Finance Dashboard or access Front Office.
