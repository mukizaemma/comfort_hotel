            ...
            <div class="row g-5 sticky-wrap">
                ...
                <div class="col-lg-5" id="booking">
                    @include('frontend.includes.booking-contact-cta', [
                        'ctaTitle' => 'Book this facility',
                        'ctaDescription' => 'Use Booking.com for reservations and contact us directly for special arrangements.'
                    ])
                </div>
            </div>
        </div>
            ...
            <div class="col-lg-4 col-md-6" style="flex: 0 0 auto;">
                <div style="background: white; border-radius: 10px; overflow: hidden; box-shadow: 0 0 10px rgba(0,0,0,0.05); transition: all 0.3s ease;">
                    ...
                    <div style="padding: 15px;">
                        ...
                        <a href="{{ route('facility',['slug'=>$facility->slug]) }}" style="display: inline-block; margin-top: 10px; font-size: 14px; color: #2176af; text-decoration: underline;">Discover More</a>
                    </div>
                </div>
            </div>
            @endforeach
