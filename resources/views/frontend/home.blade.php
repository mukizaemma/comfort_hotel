                                        ...
                                        <div class="room__card" style="height: 100%; display: flex; flex-direction: column; background: white; border-radius: 10px; overflow: hidden; box-shadow: 0 5px 15px rgba(0,0,0,0.1); transition: transform 0.3s;">
                                            ...
                                            <div class="room__card__meta" style="padding: 20px; flex: 1; display: flex; flex-direction: column;">
                                                ...
                                                <div style="display: flex; gap: 10px; margin-top: auto;">
                                                    ...
                                                    <a href="{{ route('connect') }}" class="theme-btn btn-style sm-btn fill" style="flex: 1; text-align: center;">
                                                        <span>Book Now</span>
                                                    </a>
                                                </div>
                                            </div>
        ...
        <div class="row g-30">
            ...
            <div class="col-lg-6 wow fadeInRight">
                @include('frontend.includes.booking-contact-cta', [
                    'ctaTitle' => 'Reserve your perfect room',
                    'ctaDescription' => 'Reserve your perfect room today and experience luxury hospitality at its finest.'
                ])
            </div>
        </div>
    </div>
