...
class AmenitySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $amenities = [
            ...
            ['title' => 'Hypoallergenic', 'icon' => 'fa-shield'],
            ...
            ['title' => 'Accessible', 'icon' => 'fa-wheelchair'],
            ...
            ['title' => 'Wake-up Service', 'icon' => 'fa-bell'],
            ...
            ['title' => 'Parking', 'icon' => 'fa-car'],
            ['title' => 'Free Parking', 'icon' => 'fa-parking'],
            ['title' => 'Pet Friendly', 'icon' => 'fa-paw'],
            ['title' => 'Family Rooms', 'icon' => 'fa-users'],
            ['title' => 'Connecting Rooms', 'icon' => 'fa-door-open'],
            ['title' => 'Extra Beds Available', 'icon' => 'fa-bed'],
            ['title' => 'Crib Available', 'icon' => 'fa-baby'],
            ['title' => 'High Chair Available', 'icon' => 'fa-chair'],
            ['title' => 'Baby Safety Gates', 'icon' => 'fa-shield'],
            ['title' => 'Baby Sitting Service', 'icon' => 'fa-baby'],
            ['title' => 'Playground', 'icon' => 'fa-slide'],
            ['title' => 'Kids Club', 'icon' => 'fa-child'],
            ...
            ['title' => 'Hot Tub', 'icon' => 'fa-hot-tub'],
            ['title' => 'Swimming Pool', 'icon' => 'fa-swimming-pool'],
            ['title' => 'Indoor Pool', 'icon' => 'fa-swimming-pool'],
            ['title' => 'Outdoor Pool', 'icon' => 'fa-swimming-pool'],
            ['title' => 'Beach Access', 'icon' => 'fa-umbrella-beach'],
            ['title' => 'Beachfront', 'icon' => 'fa-water'],
            ['title' => 'Golf Course', 'icon' => 'fa-golf-ball'],
            ['title' => 'Tennis Court', 'icon' => 'fa-table-tennis'],
            ...
            ['title' => 'ATM', 'icon' => 'fa-money-bill'],
            ['title' => 'Currency Exchange', 'icon' => 'fa-exchange-alt'],
            ['title' => 'Gift Shop', 'icon' => 'fa-gift'],
            ['title' => 'Souvenir Shop', 'icon' => 'fa-shopping-bag'],
            ['title' => 'Tour Desk', 'icon' => 'fa-map'],
            ['title' => 'Ticket Service', 'icon' => 'fa-ticket'],
            ['title' => 'Library', 'icon' => 'fa-book'],
            ['title' => 'Chapel', 'icon' => 'fa-church'],
            ['title' => 'Mosque', 'icon' => 'fa-mosque'],
            ...
            ['title' => 'Carbon Monoxide Detector', 'icon' => 'fa-wind'],
            ...
            ['title' => 'Vending Machine', 'icon' => 'fa-candy-cane'],
            ['title' => 'Vending Machine (Drinks)', 'icon' => 'fa-bottle-water'],
            ['title' => 'Vending Machine (Snacks)', 'icon' => 'fa-cookie'],
        ];
